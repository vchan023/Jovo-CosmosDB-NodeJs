...
describe("NodeJS CRUD Tests", function () {
        ...
        const containerCRUDTest = function (hasPartitionKey) {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    assert_1.default.equal(JSON.stringify(containerDef.partitionKey), JSON.stringify(containerDefinition.partitionKey));
    ...
    describe("Validate container indexing policy", function () {
        const indexPolicyTest = function () {
            return tslib_1.__awaiter(this, void 0, void 0, function* () {
                try {
                    ...
                    assert_1.default.equal(__1.DocumentBase.IndexKind.Hash, containerWithIndexingPolicyDef.indexingPolicy.includedPaths[0].indexes[0].kind);
                    // The second included path is a timestamp index created by the server.
                    // And one excluded path.
                    assert_1.default.equal(1, containerWithIndexingPolicyDef.indexingPolicy.excludedPaths.length, "Unexpected excludedPaths length");
        ...
        const checkDefaultIndexingPolicyPaths = function (indexingPolicy) {
            // no excluded paths.
            assert_1.default.equal(0, indexingPolicy["excludedPaths"].length);
            ...
            assert_1.default(hashIndex);
            assert_1.default.equal("String", hashIndex["dataType"]);
            assert_1.default(rangeIndex);
            assert_1.default.equal("Number", rangeIndex["dataType"]);
        };
