        ...
        describe("Async iterator should find items", function () {
            ...
            it("should fetch updated items only", function () {
                return tslib_1.__awaiter(this, void 0, void 0, function* () {
                    ...
                    const items = [];
                    try {
                        for (var _c = tslib_1.__asyncValues(iterator.getAsyncIterator()), _d; _d = yield _c.next(), !_d.done;) {
                            const page = _d.value;
                    ...
                    try {
                        for (var _e = tslib_1.__asyncValues(iterator.getAsyncIterator()), _f; _f = yield _e.next(), !_f.done;) {
                            const page = _f.value;
                            if (page.result.length === 0) {
                                break;
                            }
