...
Sign in
Sign up
42 612 91 jovotech/jovo-framework-nodejs
 Code  Issues 25  Pull requests 6  Projects 0  Insights
Join GitHub today
GitHub is home to over 28 million developers working together to host and review code, manage projects, and build software together.

jovo-framework-nodejs/lib/integrations/db/dynamoDb.js
44d476a  on Aug 3
@aswetlow aswetlow 🐛 Fixed db().deleteUser() and added user().delete()
@aswetlow @omenocal @fgnass

363 lines (334 sloc)  9.99 KB
'use strict';
